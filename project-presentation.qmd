...
<div class="grid-layout">
  <div>
    - SSVS follows the same process of embedding the entire modeling process in a hierarchical Bayesian setup, including the model selection $\gamma$
    - This can be represented as a scale mixture of normals:
