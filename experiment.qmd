...
ng_0$beta %>% 
  ...
  facet_wrap(~beta, scales = "free_y") +
  theme_bw() +
  labs(x = "Iteration", y = "Beta Value", title = "NG Progression") +
  theme(plot.title = element_text(hjust = 0.5))
...
hs_0$beta %>% 
  ...
  facet_wrap(~beta, scales = "free_y") +
  theme_bw() +
  labs(x = "Iteration", y = "Beta Value", title = "Horseshoe Progression") +
  theme(plot.title = element_text(hjust = 0.5))
...
# Probabilities of inclusion
colMeans(hs_5$beta != 0)
which(colMeans(hs_5$beta != 0) > 0.7) # Have to threshold pretty high to remove random noise

# Est. coefficients
colMeans(hs_5$beta) # Most of these are incredibly close to 0


# Lambda mostly stays low
plot(seq(N_SAMPLES - BURN_IN), hs_5$lambda2[(BURN_IN + 1):N_SAMPLES])

# Model size stays pretty consistent in that 50-55 range
plot(seq(N_SAMPLES - BURN_IN), hs_5$m[(BURN_IN + 1):N_SAMPLES])
```
...
lasso_0_out <- as.integer(colMeans(lasso_0$beta != 0) > 0.5)
lasso_0_cm <- table(true_betas_0, lasso_0_out)

ng_0_out <- as.integer(colMeans(ng_0$beta != 0) > 0.5)
ng_0_cm <- table(true_betas_0, ng_0_out)

hs_0_out <- as.integer(colMeans(hs_0$beta != 0) > 0.5)
hs_0_cm <- table(true_betas_0, hs_0_out)


model_0_rates <- rbind(c(Name = "BSS - Small", calc_rates(bss_0_small_cm), Runtime = "Seconds"),
      c(Name = "BSS - Min", calc_rates(bss_0_min_cm), Runtime = "Seconds"),
      c(Name = "BSS - All", calc_rates(bss_0_all_cm), Runtime = "Seconds"),
      c(Name = "BMS", calc_rates(bvs_0_cm), Runtime = "Seconds"),
      c(Name = "BMA", calc_rates(bma_0_cm), Runtime = "Seconds"),
      c(Name = "SSVS", calc_rates(ssvs_0_cm), Runtime = "Seconds"),
      c(Name = "LASSO", calc_rates(lasso_0_cm), Runtime = "Seconds"),
      c(Name = "Normal-Gamma", calc_rates(ng_0_cm), Runtime = "Seconds"),
      c(Name = "Horseshoe", calc_rates(hs_0_cm), Runtime = "Seconds")
  )
...
lasso_1_out <- as.integer(colMeans(lasso_1$beta != 0) > 0.5)
lasso_1_cm <- table(true_betas_1, lasso_1_out)

ng_1_out <- as.integer(colMeans(ng_1$beta != 0) > 0.5)
ng_1_cm <- table(true_betas_1, ng_1_out)

hs_1_out <- as.integer(colMeans(hs_1$beta != 0) > 0.5)
hs_1_cm <- table(true_betas_1, hs_1_out)


model_1_rates <- rbind(c(Name = "BSS - Small", calc_rates(bss_1_small_cm), Runtime = "Seconds"),
      c(Name = "BSS - Min", calc_rates(bss_1_min_cm), Runtime = "Seconds"),
      c(Name = "BSS - All", calc_rates(bss_1_all_cm), Runtime = "Seconds"),
      c(Name = "BMS", calc_rates(bvs_1_cm), Runtime = "Seconds"),
      c(Name = "BMA", calc_rates(bma_1_cm), Runtime = "Seconds"),
      c(Name = "SSVS", calc_rates(ssvs_1_cm), Runtime = "Seconds"),
      c(Name = "LASSO", calc_rates(lasso_1_cm), Runtime = "Seconds"),
      c(Name = "Normal-Gamma", calc_rates(ng_1_cm), Runtime = "Seconds"),
      c(Name = "Horseshoe", calc_rates(hs_1_cm), Runtime = "Seconds")
  )
...
lasso_2_out <- as.integer(colMeans(lasso_2$beta != 0) > 0.5)
lasso_2_cm <- table(true_betas_2, lasso_2_out)

ng_2_out <- as.integer(colMeans(ng_2$beta != 0) > 0.5)
ng_2_cm <- table(true_betas_2, ng_2_out)

hs_2_out <- as.integer(colMeans(hs_2$beta != 0) > 0.5)
hs_2_cm <- table(true_betas_2, hs_2_out)


model_2_rates <- rbind(#c(Name = "BSS - Small", calc_rates(bss_1_small_cm), Runtime = "Seconds"),
      #c(Name = "BSS - Min", calc_rates(bss_1_min_cm), Runtime = "Seconds"),
      #c(Name = "BSS - All", calc_rates(bss_1_all_cm), Runtime = "Seconds"),
      c(Name = "BMS", calc_rates(bvs_2_cm), Runtime = "Seconds"),
      c(Name = "BMA", calc_rates(bma_2_cm), Runtime = "Seconds"),
      c(Name = "SSVS", calc_rates(ssvs_2_cm), Runtime = "Seconds"),
      c(Name = "LASSO", calc_rates(lasso_2_cm), Runtime = "Seconds"),
      c(Name = "Normal-Gamma", calc_rates(ng_2_cm), Runtime = "Seconds"),
      c(Name = "Horseshoe", calc_rates(hs_2_cm), Runtime = "Seconds")
  )
...
save(c(ssvs_start, ssvs_end), file = "ssvs_5_runtime.RData")
print(ssvs_end)
...
save(c(lasso_start, lasso_end), file = "lasso_5_runtime.RData")
print(lasso_end)
...
save(c(ng_start, ng_end), file = "ng_5_runtime.RData")
print(ng_end)
...
save(c(hs_start, hs_end), file = "hs_5_runtime.RData")
print(hs_end)
...
save(c(bss_2_start, bss_2_midpoint, bss_2_end), file = "bss_2_runtime.RData")
print(bss_2_end)
...
save(c(bss_3_start, bss_3_midpoint, bss_3_end), file = "bss_3_runtime.RData")
print(bss_3_end)
...
save(c(bss_4_start, bss_4_midpoint, bss_4_end), file = "bss_4_runtime.RData")
print(bss_4_end)
...
save(c(bss_5_start, bss_5_midpoint, bss_5_end), file = "bss_5_runtime.RData")
print(bss_5_end)
```
