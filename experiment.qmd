...
which(colMeans(ng_3$beta != 0) > 0.75) # Not terrible performance, does a perfect job if you threshold it high
...
which(colMeans(ng_4$beta != 0) > 0.7) # Thresholding it high gets it pretty close, but not perfect
