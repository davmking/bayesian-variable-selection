...
```{r}
#| label: model 3 temperature test
...
emvs_3_t0_thresh <- NA
for(i in 1:6){
  temp <- find_optimal_threshold(emvs_3_t0, i, true_betas_3, N_3, P_3)
  if(temp$error < emvs_3_t0_error){
    emvs_3_t0_error <- temp$error
    emvs_3_t0_idx <- i
    emvs_3_t0_thresh <- temp$threshold
  }
}
emvs_3_t0_error
emvs_3_t0_idx
...
emvs_3_t1_thresh <- NA
for(i in 1:6){
  temp <- find_optimal_threshold(emvs_3_t1, i, true_betas_3, N_3, P_3)
  if(temp$error < emvs_3_t1_error){
    emvs_3_t1_error <- temp$error
    emvs_3_t1_idx <- i
    emvs_3_t1_thresh <- temp$threshold
  }
}
emvs_3_t1_error
emvs_3_t1_idx
...
emvs_3_t2_thresh <- NA
for(i in 1:6){
  temp <- find_optimal_threshold(emvs_3_t2, i, true_betas_3, N_3, P_3)
  if(temp$error < emvs_3_t2_error){
    emvs_3_t2_error <- temp$error
    emvs_3_t2_idx <- i
    emvs_3_t2_thresh <- temp$threshold
  }
}
emvs_3_t2_error
emvs_3_t2_idx
...
emvs_3_t3_thresh <- NA
for(i in 1:6){
  temp <- find_optimal_threshold(emvs_3_t3, i, true_betas_3, N_3, P_3)
  if(temp$error < emvs_3_t3_error){
    emvs_3_t3_error <- temp$error
    emvs_3_t3_idx <- i
    emvs_3_t3_thresh <- temp$threshold
  }
}
emvs_3_t3_error
emvs_3_t3_idx
...
emvs_3_t4_thresh <- NA
for(i in 1:6){
  temp <- find_optimal_threshold(emvs_3_t4, i, true_betas_3, N_3, P_3)
  if(temp$error < emvs_3_t4_error){
    emvs_3_t4_error <- temp$error
    emvs_3_t4_idx <- i
    emvs_3_t4_thresh <- temp$threshold
  }
}
emvs_3_t4_error
emvs_3_t4_idx
...
emvs_3_t5_thresh <- NA
for(i in 1:6){
  temp <- find_optimal_threshold(emvs_3_t5, i, true_betas_3, N_3, P_3)
  if(temp$error < emvs_3_t5_error){
    emvs_3_t5_error <- temp$error
    emvs_3_t5_idx <- i
    emvs_3_t5_thresh <- temp$threshold
  }
}
emvs_3_t5_error
emvs_3_t5_idx
...
emvs_3_t0_thresholded <- as.integer(emvs_3_t0$prob_inclusion[emvs_3_t0_idx,] > emvs_3_t0_thresh)
emvs_3_t0_thresh_cm <- table(true_betas_3, emvs_3_t0_thresholded)
emvs_3_t0_thresh_cm <- cbind(emvs_3_t0_thresh_cm, c(0, 0))

emvs_3_t1_thresholded <- as.integer(emvs_3_t1$prob_inclusion[emvs_3_t1_idx,] > emvs_3_t1_thresh)
emvs_3_t1_thresh_cm <- table(true_betas_3, emvs_3_t1_thresholded)

emvs_3_t2_thresholded <- as.integer(emvs_3_t2$prob_inclusion[emvs_3_t2_idx,] > emvs_3_t2_thresh)
emvs_3_t2_thresh_cm <- table(true_betas_3, emvs_3_t2_thresholded)

emvs_3_t3_thresholded <- as.integer(emvs_3_t3$prob_inclusion[emvs_3_t3_idx,] > emvs_3_t3_thresh)
emvs_3_t3_thresh_cm <- table(true_betas_3, emvs_3_t3_thresholded)

emvs_3_t4_thresholded <- as.integer(emvs_3_t4$prob_inclusion[emvs_3_t4_idx,] > emvs_3_t4_thresh)
emvs_3_t4_thresh_cm <- table(true_betas_3, emvs_3_t4_thresholded)

emvs_3_t5_thresholded <- as.integer(emvs_3_t5$prob_inclusion[emvs_3_t5_idx,] > emvs_3_t5_thresh)
emvs_3_t5_thresh_cm <- table(true_betas_3, emvs_3_t5_thresholded)
...
emvs_3_t0_est <- emvs_3_t0$betas[1,]
emvs_3_t1_est <- emvs_3_t1$betas[1,]
emvs_3_t2_est <- emvs_3_t2$betas[1,]
emvs_3_t3_est <- emvs_3_t3$betas[1,]
emvs_3_t4_est <- emvs_3_t4$betas[1,]
emvs_3_t5_est <- emvs_3_t5$betas[1,]

# Signal coefficients
mean((emvs_3_t0_est[which(true_betas_3 == 1)] - beta_vals_3[which(true_betas_3 == 1)])^2)
mean((emvs_3_t1_est[which(true_betas_3 == 1)] - beta_vals_3[which(true_betas_3 == 1)])^2)
mean((emvs_3_t2_est[which(true_betas_3 == 1)] - beta_vals_3[which(true_betas_3 == 1)])^2)
mean((emvs_3_t3_est[which(true_betas_3 == 1)] - beta_vals_3[which(true_betas_3 == 1)])^2)
mean((emvs_3_t4_est[which(true_betas_3 == 1)] - beta_vals_3[which(true_betas_3 == 1)])^2)
mean((emvs_3_t5_est[which(true_betas_3 == 1)] - beta_vals_3[which(true_betas_3 == 1)])^2)
# Minimized at t = 2

# All coefficients
mean((emvs_3_t0_est - beta_vals_3)^2)
mean((emvs_3_t1_est - beta_vals_3)^2)
mean((emvs_3_t2_est - beta_vals_3)^2)
mean((emvs_3_t3_est - beta_vals_3)^2)
mean((emvs_3_t4_est - beta_vals_3)^2)
mean((emvs_3_t5_est - beta_vals_3)^2)
# Minimized at t = 10

# Train MSE
mean(((X_3 %*% as.matrix(c(-1, emvs_3_t0_est))) - y_3)^2)
mean(((X_3 %*% as.matrix(c(-1, emvs_3_t1_est))) - y_3)^2)
mean(((X_3 %*% as.matrix(c(-1, emvs_3_t2_est))) - y_3)^2)
mean(((X_3 %*% as.matrix(c(-1, emvs_3_t3_est))) - y_3)^2)
mean(((X_3 %*% as.matrix(c(-1, emvs_3_t4_est))) - y_3)^2)
mean(((X_3 %*% as.matrix(c(-1, emvs_3_t5_est))) - y_3)^2)
# Minimized at low temperatures

# Test MSE
mean(((X_3_test %*% as.matrix(c(-1, emvs_3_t0_est))) - y_3_test)^2)
mean(((X_3_test %*% as.matrix(c(-1, emvs_3_t1_est))) - y_3_test)^2)
mean(((X_3_test %*% as.matrix(c(-1, emvs_3_t2_est))) - y_3_test)^2)
mean(((X_3_test %*% as.matrix(c(-1, emvs_3_t3_est))) - y_3_test)^2)
mean(((X_3_test %*% as.matrix(c(-1, emvs_3_t4_est))) - y_3_test)^2)
mean(((X_3_test %*% as.matrix(c(-1, emvs_3_t5_est))) - y_3_test)^2)
# Minimized at t = 10
# Performance roughly comparable with other models at this level
```
...
```{r}
#| label: model 4 temperature test
...
emvs_4_t0_thresh <- NA
for(i in 1:6){
  temp <- find_optimal_threshold(emvs_4_t0, i, true_betas_4, N_4, P_4)
  if(temp$error < emvs_4_t0_error){
    emvs_4_t0_error <- temp$error
    emvs_4_t0_idx <- i
    emvs_4_t0_thresh <- temp$threshold
  }
}
emvs_4_t0_error
emvs_4_t0_idx
...
emvs_4_t1_thresh <- NA
for(i in 1:6){
  temp <- find_optimal_threshold(emvs_4_t1, i, true_betas_4, N_4, P_4)
  if(temp$error < emvs_4_t1_error){
    emvs_4_t1_error <- temp$error
    emvs_4_t1_idx <- i
    emvs_4_t1_thresh <- temp$threshold
  }
}
emvs_4_t1_error
emvs_4_t1_idx
...
emvs_4_t2_thresh <- NA
for(i in 1:6){
  temp <- find_optimal_threshold(emvs_4_t2, i, true_betas_4, N_4, P_4)
  if(temp$error < emvs_4_t2_error){
    emvs_4_t2_error <- temp$error
    emvs_4_t2_idx <- i
    emvs_4_t2_thresh <- temp$threshold
  }
}
emvs_4_t2_error
emvs_4_t2_idx
...
emvs_4_t3_thresh <- NA
for(i in 1:6){
  temp <- find_optimal_threshold(emvs_4_t3, i, true_betas_4, N_4, P_4)
  if(temp$error < emvs_4_t3_error){
    emvs_4_t3_error <- temp$error
    emvs_4_t3_idx <- i
    emvs_4_t3_thresh <- temp$threshold
  }
}
emvs_4_t3_error
emvs_4_t3_idx
...
emvs_4_t4_thresh <- NA
for(i in 1:6){
  temp <- find_optimal_threshold(emvs_4_t4, i, true_betas_4, N_4, P_4)
  if(temp$error < emvs_4_t4_error){
    emvs_4_t4_error <- temp$error
    emvs_4_t4_idx <- i
    emvs_4_t4_thresh <- temp$threshold
  }
}
emvs_4_t4_error
emvs_4_t4_idx
...
emvs_4_t5_thresh <- NA
for(i in 1:6){
  temp <- find_optimal_threshold(emvs_4_t5, i, true_betas_4, N_4, P_4)
  if(temp$error < emvs_4_t5_error){
    emvs_4_t5_error <- temp$error
    emvs_4_t5_idx <- i
    emvs_4_t5_thresh <- temp$threshold
  }
}
emvs_4_t5_error
emvs_4_t5_idx
...
emvs_4_t0_thresholded <- as.integer(emvs_4_t0$prob_inclusion[emvs_4_t0_idx,] > emvs_4_t0_thresh)
emvs_4_t0_thresh_cm <- table(true_betas_4, emvs_4_t0_thresholded)
emvs_4_t0_thresh_cm <- cbind(emvs_4_t0_thresh_cm, c(0, 0))

emvs_4_t1_thresholded <- as.integer(emvs_4_t1$prob_inclusion[emvs_4_t1_idx,] > emvs_4_t1_thresh)
emvs_4_t1_thresh_cm <- table(true_betas_4, emvs_4_t1_thresholded)

emvs_4_t2_thresholded <- as.integer(emvs_4_t2$prob_inclusion[emvs_4_t2_idx,] > emvs_4_t2_thresh)
emvs_4_t2_thresh_cm <- table(true_betas_4, emvs_4_t2_thresholded)

emvs_4_t3_thresholded <- as.integer(emvs_4_t3$prob_inclusion[emvs_4_t3_idx,] > emvs_4_t3_thresh)
emvs_4_t3_thresh_cm <- table(true_betas_4, emvs_4_t3_thresholded)

emvs_4_t4_thresholded <- as.integer(emvs_4_t4$prob_inclusion[emvs_4_t4_idx,] > emvs_4_t4_thresh)
emvs_4_t4_thresh_cm <- table(true_betas_4, emvs_4_t4_thresholded)

emvs_4_t5_thresholded <- as.integer(emvs_4_t5$prob_inclusion[emvs_4_t5_idx,] > emvs_4_t5_thresh)
emvs_4_t5_thresh_cm <- table(true_betas_4, emvs_4_t5_thresholded)
...
emvs_4_t0_est <- emvs_4_t0$betas[1,]
emvs_4_t1_est <- emvs_4_t1$betas[1,]
emvs_4_t2_est <- emvs_4_t2$betas[1,]
emvs_4_t3_est <- emvs_4_t3$betas[1,]
emvs_4_t4_est <- emvs_4_t4$betas[1,]
emvs_4_t5_est <- emvs_4_t5$betas[1,]

# Signal coefficients
mean((emvs_4_t0_est[which(true_betas_4 == 1)] - beta_vals_4[which(true_betas_4 == 1)])^2)
mean((emvs_4_t1_est[which(true_betas_4 == 1)] - beta_vals_4[which(true_betas_4 == 1)])^2)
mean((emvs_4_t2_est[which(true_betas_4 == 1)] - beta_vals_4[which(true_betas_4 == 1)])^2)
mean((emvs_4_t3_est[which(true_betas_4 == 1)] - beta_vals_4[which(true_betas_4 == 1)])^2)
mean((emvs_4_t4_est[which(true_betas_4 == 1)] - beta_vals_4[which(true_betas_4 == 1)])^2)
mean((emvs_4_t5_est[which(true_betas_4 == 1)] - beta_vals_4[which(true_betas_4 == 1)])^2)
# Minimized at t = 1

# All coefficients
mean((emvs_4_t0_est - beta_vals_4)^2)
mean((emvs_4_t1_est - beta_vals_4)^2)
mean((emvs_4_t2_est - beta_vals_4)^2)
mean((emvs_4_t3_est - beta_vals_4)^2)
mean((emvs_4_t4_est - beta_vals_4)^2)
mean((emvs_4_t5_est - beta_vals_4)^2)
# Minimized at t = 10

# Train MSE
mean(((X_4 %*% as.matrix(c(-1, emvs_4_t0_est))) - y_4)^2)
mean(((X_4 %*% as.matrix(c(-1, emvs_4_t1_est))) - y_4)^2)
mean(((X_4 %*% as.matrix(c(-1, emvs_4_t2_est))) - y_4)^2)
mean(((X_4 %*% as.matrix(c(-1, emvs_4_t3_est))) - y_4)^2)
mean(((X_4 %*% as.matrix(c(-1, emvs_4_t4_est))) - y_4)^2)
mean(((X_4 %*% as.matrix(c(-1, emvs_4_t5_est))) - y_4)^2)
# Minimized at low temperatures

# Test MSE
mean(((X_4_test %*% as.matrix(c(-1, emvs_4_t0_est))) - y_4_test)^2)
mean(((X_4_test %*% as.matrix(c(-1, emvs_4_t1_est))) - y_4_test)^2)
mean(((X_4_test %*% as.matrix(c(-1, emvs_4_t2_est))) - y_4_test)^2)
mean(((X_4_test %*% as.matrix(c(-1, emvs_4_t3_est))) - y_4_test)^2)
mean(((X_4_test %*% as.matrix(c(-1, emvs_4_t4_est))) - y_4_test)^2)
mean(((X_4_test %*% as.matrix(c(-1, emvs_4_t5_est))) - y_4_test)^2)
# Minimized at t = 10
# It still performs worse than some of the other methods at this level, though
```
...
model_coef_0 <- data.frame(true_values = beta_vals_0,
           BMA = bma_0_est,
           EMVS = emvs_0_est,
           SSVS = ssvs_0_est,
           TRUTH = beta_vals_0,
  ...
  labs(x = "True Coefficient",
       title = "Model 1 Mean Coefficient Estimates vs. Truth",
       subtitle = "Black Bars Represent Truth") +
  theme(plot.title = element_text(hjust = 0.5),
  ...
  scale_fill_viridis(discrete = TRUE, option = "A", direction = -1)
save(model_coef_0, file = "model_coef_0.RData")
```
...
model_coef_3 <- data.frame(true_values = beta_vals_3,
           BMA = bma_3_est,
           EMVS = emvs_3_est,
           EMVS_DA = emvs_3_t4_est,
           SSVS = ssvs_3_est,
           TRUTH = beta_vals_3,
           LASSO = lasso_3_est,
           Normal.Gamma = ng_3_est,
  ...
  theme_bw() +
  labs(x = "True Coefficient",
       title = "Model 2 Mean Coefficient Estimates vs. Truth",
       subtitle = "Black Bars Represent Truth") +
  theme(plot.title = element_text(hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5),
        panel.grid.minor.x = element_blank(),
        ...
        legend.position = "bottom") +
  scale_fill_viridis(discrete = TRUE, option = "A", direction = -1)
save(model_coef_3, file = "model_coef_3.RData")
```
...
model_coef_4 <-data.frame(true_values = beta_vals_4,
           BMA = bma_4_est,
           EMVS = emvs_4_est,
           EMVS_DA = emvs_4_t4_est,
           SSVS = ssvs_4_est,
           TRUTH = beta_vals_4,
           LASSO = lasso_4_est,
           Normal.Gamma = ng_4_est,
  ...
  theme_bw() +
  labs(x = "True Coefficient",
       title = "Model 3 Mean Coefficient Estimates vs. Truth",
       subtitle = "Black Bars Represent Truth") +
  theme(plot.title = element_text(hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5),
        panel.grid.minor.x = element_blank(),
        ...
        legend.position = "bottom") +
  scale_fill_viridis(discrete = TRUE, option = "A", direction = -1)
save(model_coef_4, file = "model_coef_4.RData")
```
...
model_coef_5 <- data.frame(true_values = beta_vals_5,
           BMA = bma_5_est,
           EMVS = emvs_5_est,
           EMVS_DA = emvs_5_t4_est,
           SSVS = ssvs_5_est,
           TRUTH = beta_vals_5,
           LASSO = lasso_5_est,
           Normal.Gamma = ng_5_est,
  ...
  theme_bw() +
  labs(x = "True Coefficient",
       title = "Model 4 Mean Coefficient Estimates vs. Truth",
       subtitle = "Black Bars Represent Truth") +
  theme(plot.title = element_text(hjust = 0.5),
        plot.subtitle = element_text(hjust = 0.5),
        panel.grid.minor.x = element_blank(),
        ...
        legend.position = "bottom") +
  scale_fill_viridis(discrete = TRUE, option = "A", direction = -1)
save(model_coef_5, file = "model_coef_5.RData")
```
...
model_3_rates <- rbind(
      ...
      c(Name = paste0("EMVS, p = ", round(emvs_3_t4_thresh, 3), ", t = 10"),
        Size = sum(emvs_3_t4_thresholded),
        calc_rates(emvs_3_t4_thresh_cm), runtime = "Ms",
        MSE_Nonzero = mean((emvs_3_t4_est[which(true_betas_3 == 1)] -
                              beta_vals_3[which(true_betas_3 == 1)])^2),
        MSE_All = mean((emvs_3_t4_est - beta_vals_3)^2),
        MSE_Resp = mean(((X_3 %*% as.matrix(c(-1, emvs_3_t4_est))) - y_3)^2),
        MSE_Resp_Test = mean(((X_3_test %*% as.matrix(c(-1, emvs_3_t4_est))) - y_3_test)^2))
  )
...
model_4_rates <- rbind(
      ...
      c(Name = paste0("EMVS, p = ", round(emvs_4_t4_thresh, 3), ", t = 10"),
        Size = sum(emvs_4_t4_thresholded),
        calc_rates(emvs_4_t4_thresh_cm), runtime = "Ms",
        MSE_Nonzero = mean((emvs_4_t4_est[which(true_betas_4 == 1)] -
                              beta_vals_4[which(true_betas_4 == 1)])^2),
        MSE_All = mean((emvs_4_t4_est - beta_vals_4)^2),
        MSE_Resp = mean(((X_4 %*% as.matrix(c(-1, emvs_4_t4_est))) - y_4)^2),
        MSE_Resp_Test = mean(((X_4_test %*% as.matrix(c(-1, emvs_4_t4_est))) - y_4_test)^2))
  )
...
model_5_rates <- rbind(
      ...
      c(Name = paste0("EMVS, p = ", round(emvs_5_t4_thresh, 3), ", t = 10"),
        Size = sum(emvs_5_t4_thresholded),
        calc_rates(emvs_5_t4_thresh_cm), runtime = "Ms",
        MSE_Nonzero = mean((emvs_5_t4_est[which(true_betas_5 == 1)] -
                              beta_vals_5[which(true_betas_5 == 1)])^2),
        MSE_All = mean((emvs_5_t4_est - beta_vals_5)^2),
        MSE_Resp = mean(((X_5 %*% as.matrix(c(-1, emvs_5_t4_est))) - y_5)^2),
        MSE_Resp_Test = mean(((X_5_test %*% as.matrix(c(-1, emvs_5_t4_est))) - y_5_test)^2))
  )
