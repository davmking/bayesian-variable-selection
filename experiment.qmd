...
bss_0_small_cm <- table(true_betas_0, bss_0_small)
bss_0_min_cm <- table(true_betas_0, bss_0_min)
bss_0_all_cm <- table(true_betas_0, bss_0_all)
...
model_0_rates <- rbind(
      #c(Name = "BSS - Small", Size = sum(bss_0_small),
        #calc_rates(bss_0_small_cm), Runtime = "Seconds"),
      #c(Name = "BSS - Min", Size = sum(bss_0_min),
        #calc_rates(bss_0_min_cm), Runtime = "Seconds"),
      #c(Name = "BSS - All", Size = sum(bss_0_all),
        #calc_rates(bss_0_all_cm), Runtime = "Seconds"),
      c(Name = "BMS", Size = sum(bvs_0$HPMbin),
        calc_rates(bvs_0_cm), Runtime = "Seconds",
       MSE_Select = NA, MSE_All = NA),
      c(Name = "BMA", Size = sum(bma_0_out),
        calc_rates(bma_0_cm), Runtime = "Seconds",
        MSE_Select = mean((bma_0_est[which(true_betas_0 == 1)] -
                             beta_vals_0[which(true_betas_0 == 1)])^2),
        MSE_All = mean((bma_0_est - beta_vals_0)^2)),
      c(Name = "SSVS", Size = sum(ssvs_0_out),
        calc_rates(ssvs_0_cm), Runtime = "Seconds",
        MSE_Select = mean((ssvs_0_est[which(true_betas_0 == 1)] -
                             beta_vals_0[which(true_betas_0 == 1)])^2),
        MSE_All = mean((ssvs_0_est - beta_vals_0)^2)),
      c(Name = "LASSO", Size = sum(lasso_0_out),
        calc_rates(lasso_0_cm), Runtime = "Seconds",
        MSE_Select = mean((lasso_0_est[which(true_betas_0 == 1)] -
                             beta_vals_0[which(true_betas_0 == 1)])^2),
        MSE_All = mean((lasso_0_est - beta_vals_0)^2)),
      c(Name = "Normal-Gamma", Size = sum(ng_0_out),
        calc_rates(ng_0_cm), Runtime = "Seconds",
        MSE_Select = mean((ng_0_est[which(true_betas_0 == 1)] -
                             beta_vals_0[which(true_betas_0 == 1)])^2),
        MSE_All = mean((ng_0_est - beta_vals_0)^2)),
      c(Name = "Horseshoe", Size = sum(hs_0_out),
        calc_rates(hs_0_cm), Runtime = "Seconds",
        MSE_Select = mean((hs_0_est[which(true_betas_0 == 1)] -
                             beta_vals_0[which(true_betas_0 == 1)])^2),
        MSE_All = mean((hs_0_est - beta_vals_0)^2)),
      c(Name = "EMVS", Size = sum(emvs_0_out),
        calc_rates(emvs_0_cm), Runtime = "Milliseconds",
        MSE_Select = mean((emvs_0_est[which(true_betas_0 == 1)] -
                             beta_vals_0[which(true_betas_0 == 1)])^2),
...
bss_1_small_cm <- table(true_betas_1, bss_1_small)
bss_1_min_cm <- table(true_betas_1, bss_1_min)
bss_1_all_cm <- table(true_betas_1, bss_1_all)
...
model_1_rates <- rbind(
      c(Name = "BSS - Small", Size = sum(bss_1_small),
        calc_rates(bss_1_small_cm), Runtime = "Seconds"),
      c(Name = "BSS - Min", Size = sum(bss_1_min),
        calc_rates(bss_1_min_cm), Runtime = "Seconds"),
      c(Name = "BSS - All", Size = sum(bss_1_all),
        calc_rates(bss_1_all_cm), Runtime = "Seconds"),
      c(Name = "BMS", Size = sum(bvs_1$HPMbin),
        calc_rates(bvs_1_cm), Runtime = "Seconds"),
      c(Name = "BMA", Size = sum(bma_1_out),
        calc_rates(bma_1_cm), Runtime = "Seconds"),
      c(Name = "SSVS", Size = sum(ssvs_1_out),
        calc_rates(ssvs_1_cm), Runtime = "Seconds"),
      c(Name = "LASSO", Size = sum(lasso_1_out),
        calc_rates(lasso_1_cm), Runtime = "Seconds"),
      c(Name = "Normal-Gamma", Size = sum(ng_1_out),
        calc_rates(ng_1_cm), Runtime = "Seconds"),
      c(Name = "Horseshoe", Size = sum(hs_1_out),
        calc_rates(hs_1_cm), Runtime = "Seconds"),
      c(Name = "EMVS", Size = sum(emvs_1_out),
        calc_rates(emvs_1_cm), Runtime = "Milliseconds")
  )
...
model_3_rates <- rbind(
      c(Name = "BMS", Size = sum(bvs_3$HPMbin),
        calc_rates(bvs_3_cm), Runtime = "Seconds"),
      c(Name = "BMA", Size = sum(bma_3_out),
        calc_rates(bma_3_cm), Runtime = "Seconds"),
      c(Name = "SSVS, p = 0.5", Size = sum(ssvs_3_out),
        calc_rates(ssvs_3_cm), Runtime = "Seconds"),
      c(Name = paste("SSVS, p =", round(ssvs_3_threshold, 3)),
        Size = sum(ssvs_3_thresholded),
        calc_rates(ssvs_3_thresh_cm), runtime = "Seconds"),
      c(Name = "LASSO, p = 0.5", Size = sum(lasso_3_out),
        calc_rates(lasso_3_cm), Runtime = "Minutes"),
      c(Name = paste("LASSO, p =", round(lasso_3_threshold, 3)),
        Size = sum(lasso_3_thresholded),
        calc_rates(lasso_3_thresh_cm), runtime = "Minutes"),
      c(Name = "Normal-Gamma, p = 0.5", Size = sum(ng_3_out),
        calc_rates(ng_3_cm), Runtime = "Minutes"),
      c(Name = paste("Normal-Gamma, p =", round(ng_3_threshold, 3)),
        Size = sum(ng_3_thresholded),
        calc_rates(ng_3_thresh_cm), runtime = "Minutes"),
      c(Name = "Horseshoe, p = 0.5", Size = sum(hs_3_out),
        calc_rates(hs_3_cm), Runtime = "Minutes"),
      c(Name = paste("Horseshoe, p =", round(hs_3_threshold, 3)),
        Size = sum(hs_3_thresholded),
        calc_rates(hs_3_thresh_cm), runtime = "Minutes"),
      c(Name = "EMVS, p = 0.5", Size = sum(emvs_3_out),
        calc_rates(emvs_3_cm), Runtime = "Milliseconds"),
      c(Name = paste("EMVS, p =", round(emvs_3_thresh, 3)),
        Size = sum(emvs_3_thresholded),
        calc_rates(emvs_3_thresh_cm), runtime = "Milliseconds")
  )
...
model_4_rates <- rbind(
      c(Name = "BMS", Size = sum(bvs_4$HPMbin),
        calc_rates(bvs_4_cm), Runtime = "Seconds"),
      c(Name = "BMA", Size = sum(bma_4_out),
        calc_rates(bma_4_cm), Runtime = "Seconds"),
      c(Name = "SSVS, p = 0.5", Size = sum(ssvs_4_out),
        calc_rates(ssvs_4_cm), Runtime = "Seconds"),
      c(Name = paste("SSVS, p =", round(ssvs_4_threshold, 3)),
        Size = sum(ssvs_4_thresholded),
        calc_rates(ssvs_4_thresh_cm), runtime = "Seconds"),
      c(Name = "LASSO, p = 0.5", Size = sum(lasso_4_out),
        calc_rates(lasso_4_cm), Runtime = "Minutes"),
      c(Name = paste("LASSO, p =", round(lasso_4_threshold, 3)),
        Size = sum(lasso_4_thresholded),
        calc_rates(lasso_4_thresh_cm), runtime = "Minutes"),
      c(Name = "Normal-Gamma, p = 0.5", Size = sum(ng_4_out),
        calc_rates(ng_4_cm), Runtime = "Minutes"),
      c(Name = paste("Normal-Gamma, p =", round(ng_4_threshold, 3)),
        Size = sum(ng_4_thresholded),
        calc_rates(ng_4_thresh_cm), runtime = "Minutes"),
      c(Name = "Horseshoe, p = 0.5", Size = sum(hs_4_out),
        calc_rates(hs_4_cm), Runtime = "Minutes"),
      c(Name = paste("Horseshoe, p =", round(hs_4_threshold, 3)),
        Size = sum(hs_4_thresholded),
        calc_rates(hs_4_thresh_cm), runtime = "Minutes"),
      c(Name = "EMVS, p = 0.5", Size = sum(emvs_4_out),
        calc_rates(emvs_4_cm), Runtime = "Milliseconds"),
      c(Name = paste("EMVS, p =", round(emvs_4_thresh, 3)),
        Size = sum(emvs_4_thresholded),
        calc_rates(emvs_4_thresh_cm), runtime = "Milliseconds")
  )
...
model_5_rates <- rbind(
      c(Name = "BMS", Size = sum(bvs_5$HPMbin),
        calc_rates(bvs_5_cm), Runtime = "Minutes"),
      c(Name = "BMA", Size = sum(bma_5_out),
        calc_rates(bma_5_cm), Runtime = "Seconds"),
      c(Name = "SSVS, p = 0.5", Size = sum(ssvs_5_out),
        calc_rates(ssvs_5_cm), Runtime = "Minutes"),
      c(Name = paste("SSVS, p =", round(ssvs_5_threshold, 3)),
        Size = sum(ssvs_5_thresholded),
        calc_rates(ssvs_5_thresh_cm), runtime = "Minutes"),
      c(Name = "LASSO, p = 0.5", Size = sum(lasso_5_out),
        calc_rates(lasso_5_cm), Runtime = "Hours"),
      c(Name = paste("LASSO, p =", round(lasso_5_threshold, 3)),
        Size = sum(lasso_5_thresholded),
        calc_rates(lasso_5_thresh_cm), runtime = "Hours"),
      c(Name = "Normal-Gamma, p = 0.5", Size = sum(ng_5_out),
        calc_rates(ng_5_cm), Runtime = "Hours"),
      c(Name = paste("Normal-Gamma, p =", round(ng_5_threshold, 3)),
        Size = sum(ng_5_thresholded),
        calc_rates(ng_5_thresh_cm), runtime = "Hours"),
      c(Name = "Horseshoe, p = 0.5", Size = sum(hs_5_out),
        calc_rates(hs_5_cm), Runtime = "Hours"),
      c(Name = paste("Horseshoe, p =", round(hs_5_threshold, 3)),
        Size = sum(hs_5_thresholded),
        calc_rates(hs_5_thresh_cm), runtime = "Hours"),
      c(Name = "EMVS, p = 0.5", Size = sum(emvs_5_out),
        calc_rates(emvs_5_cm), Runtime = "Milliseconds"),
      c(Name = paste("EMVS, p =", round(emvs_5_thresh, 3)),
        Size = sum(emvs_5_thresholded),
        calc_rates(emvs_5_thresh_cm), runtime = "Milliseconds")
  )
