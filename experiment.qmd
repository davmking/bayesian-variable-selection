...
bss_0_small <- which(accept_info_0$beta_hat_small[-1] != 0)
bss_0_small
...
bss_0_min <- which(accept_info_0$beta_hat_min[-1] != 0)
bss_0_min
...
ng_0_cm <- table(true_betas_0, hs_0_out)
```
