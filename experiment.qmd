...
model_4_rates <- rbind(
      ...
      c(Name = "SSVS", Size = sum(ssvs_4_out),
        calc_rates(ssvs_4_cm), Runtime = "Seconds"),
      c(Name = "LASSO", Size = sum(lasso_4_out),
        calc_rates(lasso_4_cm), Runtime = "Minutes"),
      c(Name = "Normal-Gamma", Size = sum(ng_4_out),
        calc_rates(ng_4_cm), Runtime = "Minutes"),
      c(Name = "Horseshoe", Size = sum(hs_4_out),
...
model_5_rates <- rbind(
      ...
      c(Name = "SSVS", Size = sum(ssvs_5_out),
        calc_rates(ssvs_5_cm), Runtime = "Minutes"),
      c(Name = "LASSO", Size = sum(lasso_5_out),
        calc_rates(lasso_5_cm), Runtime = "Hours"),
      c(Name = "Normal-Gamma", Size = sum(ng_5_out),
        calc_rates(ng_5_cm), Runtime = "Hours"),
      c(Name = "Horseshoe", Size = sum(hs_5_out),
