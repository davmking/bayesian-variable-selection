...
which(colMeans(hs_3$beta != 0) > 0.7) # Not terrible performance, does a better job if you threshold it high

# Est. coefficients
colMeans(hs_3$beta) # Most of these are incredibly close to 0
# Shrinkage still affecting our coefficients
...
which(colMeans(hs_4$beta != 0) > 0.65) # Thresholding it high gets it pretty close, but not perfect

# Est. coefficients
colMeans(hs_4$beta) # Most of these are incredibly close to 0
