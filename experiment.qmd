...
model_0_rates <- rbind(
      ...
      c(Name = "BMS", Size = sum(bvs_0$HPMbin),
        ...
        MSE_Nonzero = NA, MSE_All = NA, MSE_Resp = NA),
...
model_3_rates <- rbind(
      ...
      #c(Name = "SSVS, p = 0.5", Size = sum(ssvs_3_out),
        #calc_rates(ssvs_3_cm), Runtime = "S",
      ...
      #c(Name = "LASSO, p = 0.5", Size = sum(lasso_3_out),
        #calc_rates(lasso_3_cm), Runtime = "M",
      ...
      #c(Name = "EMVS, p = 0.5", Size = sum(emvs_3_out),
        #calc_rates(emvs_3_cm), Runtime = "Ms",
