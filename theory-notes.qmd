...
In this case, both hyperparameters are important.
...
This might not be super possible to plot, due to the nature of a Dirichlet distribution in high dimensions. We will see.
