...
The horseshoe prior setting results in a shrinkage coefficient that places a lot of mass near 0 (indicating signals) 1 one (indicating noise), giving the horseshoe prior its name.
