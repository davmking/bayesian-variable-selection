...
The `monomvn` package can be used to implement LASSO, NG, horesehoe, and ridge priors. The horseshoe+ can be implemented using `Bayereg`. The SSLASSO can be implemented using `SSLASSO()` from the package of the same name.
